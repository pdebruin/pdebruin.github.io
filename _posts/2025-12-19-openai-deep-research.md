...
description: "Learn MCP Server now supports OpenAI's deep research pattern with search and fetch tools for richer AI-powered documentation queries."
categories:
  - Learning
tags:
...
![OpenAI platform showing deep research with Learn MCP Server, reasoning through Azure deployment options using search and fetch tools](/assets/images/2025-12-19-openai-deep-research.jpg)
