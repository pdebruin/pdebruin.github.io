...
description: "Use Azure Developer CLI to deploy templates and set up CI/CD pipelines faster than the retired DevOps Starter."
categories:
  - Learning
tags:
  - Devops
...
![Azure DevOps Starter dashboard with sample app and CI/CD pipeline](../assets/images/2022-10-07-azd-cli1.jpg)
...
![Azure Developer CLI (azd) command-line tool deploying from community templates](../assets/images/2022-10-07-azd-cli2.jpg)
